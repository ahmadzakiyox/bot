...
const facebook_v1_js_1 = require("../types/facebook-v1.js");
const constant_js_1 = require("./constant.js");
async function facebookdl(url) {
    facebook_v1_js_1.FacebookDlArgsSchema.parse(arguments);
    const html = await (0, got_1.default)('https://fdownloader.net/en', {
        headers: {
    ...
    const data = await got_1.default.post(k_url_search, {
        headers: {
            ...constant_js_1.DEFAULT_HEADERS,
    ...
    console.log(result);
    return facebook_v1_js_1.FacebookDlSchema.parse(result);
}
exports.default = facebookdl;
